...
PoltergeistAgent = (function() {
  ...
  PoltergeistAgent.prototype.find = function(method, selector, within) {
    var el, error, i, j, len, ref, results, results1, xpath;
    if (within == null) {
      within = document;
    }
    try {
      ...
      error = error1;
      if ((ref = error.code) === DOMException.SYNTAX_ERR || ref === 51) {
  ...
  PoltergeistAgent.prototype.wrapResults = function(result, page_id) {
    ...
    switch (false) {
      ...
      case !(result instanceof NodeList):
        results1 = [];
...
PoltergeistAgent.Node = (function() {
  ...
  Node.prototype.parentIds = function() {
    var elem, ids, results1;
    ids = [];
    elem = this.element;
    results1 = [];
    while ((elem = elem.parentNode) !== document) {
      results1.push(this.agent.register(elem));
    }
    return results1;
  };
  ...
  Node.prototype.visibleText = function() {
    if (this.isVisible()) {
      switch (false) {
        ...
        case !(this.element instanceof SVGElement):
          return this.element.textContent;
        default:
  ...
  Node.prototype.path = function() {
    ...
    elements = (function() {
      ...
      for (j = ref.length - 1; j >= 0; j += -1) {
        id = ref[j];
        results1.push(this.agent.get(id));
      }
      return results1;
    }).call(this);
    elements.push(this);
  ...
  Node.prototype.trigger = function(name, element) {
    ...
    event = (function() {
      switch (false) {
        case indexOf.call(Node.EVENTS.MOUSE, name) < 0:
          e = document.createEvent('MouseEvent');
          e.initMouseEvent(name, true, true, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);
          return e;
        case indexOf.call(Node.EVENTS.FOCUS, name) < 0:
          return this.obtainEvent(name);
        case indexOf.call(Node.EVENTS.FORM, name) < 0:
          return this.obtainEvent(name);
        default:
          throw "Unknown event";
      }
